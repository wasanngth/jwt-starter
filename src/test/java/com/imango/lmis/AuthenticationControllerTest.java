...
import com.imango.lmis.api.rest.AuthenticationResources;
import com.imango.lmis.common.DeviceProvider;
import com.imango.lmis.common.TimeProvider;
import com.imango.lmis.model.Authority;
import com.imango.lmis.model.User;
import com.imango.lmis.model.UserRoleName;
import com.imango.lmis.security.DeviceDummy;
import com.imango.lmis.security.TokenHelper;
import com.imango.lmis.service.impl.CustomUserDetailsService;
...
public class AuthenticationControllerTest {
	...
	@InjectMocks
	private AuthenticationResources authenticationController;
	...
	public void setup() {
		...
		ReflectionTestUtils.setField(tokenHelper, "SECRET", "jwtdemo");
	...
	public void shouldRefreshNotExpiredWebToken() throws Exception {
		...
		given(deviceProvider.getCurrentDevice(any())).willReturn(device);
